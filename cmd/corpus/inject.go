...
// stopByte сообщает, что знак завершает предложение или его часть. Набор
// знаков перечислен ветвями, а не цепочкой сравнений: список читается одним
// взглядом и не растёт вширь, когда добавляется ещё один знак.
