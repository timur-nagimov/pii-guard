...
func TestExtraDocumentsDetector(t *testing.T) {
	...
	cases := []cardHolderCase{
		...
		{"билет военнообязанного", "Билет военнообязанного: ЕС-1210027", "ЕС-1210027", TypeMilitaryID, ConfHigh},
		{"билет военнообязанного без серии", "Билет военнообязанного: 1234567", "1234567", TypeMilitaryID, ConfAnchored},
		{"военный билет в выгрузке без якоря", "Назару Нуриеву;8 (937) 7187225;АН-2850498;с. 1691 н. 898210;619803;01 10 2003;OK", "АН-2850498", TypeMilitaryID, ConfAnchored},
		{"военный билет слитый со следующей сущностью", "воинский документ НА № 4819577 930956 — паспорт выдан", "НА № 4819577", TypeMilitaryID, ConfHigh},
		{"военный билет в таблице без якоря", "830936\t11 мая 2024\t743\tМТ-7568234\t201346776228\tОТДЕЛОМ ВНУТРЕННИХ ДЕЛ Г. ЛИПЕЦК\tclosed", "МТ-7568234", TypeMilitaryID, ConfAnchored},
		{"билет на самолёт не военный", "Билет на самолёт АБ 1234567", "", TypeMilitaryID, 0},
