...
var (
	anchorsPassport = []string{"паспорт", "пасп", "серия", "серии", "сери", "номер", "№", "выдан", "удостоверение личности", "паспортные данные", "данные документа", "документ"}
	...
	anchorsStrongPersonal = []string{"паспорт", "пасп", "серия", "серии", "снилс", "инн", "карт", "подразделени", "к/п", "индекс", "телефон", "удостоверен", "водительск"}
